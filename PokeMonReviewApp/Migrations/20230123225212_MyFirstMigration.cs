    ...
    public partial class MyFirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PokemonId = table.Column<int>(type: "int", nullable: false),
                    OnwerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonOwners", x => new { x.PokemonId, x.OnwerId });
                    table.ForeignKey(
                        name: "FK_PokemonOwners_Owners_OnwerId",
                        column: x => x.OnwerId,
